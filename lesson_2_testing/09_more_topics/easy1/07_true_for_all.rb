...
actual solution works with any Enumerable collection). In this
exercise, you will develop its companion, all?.
...
return true if the block returns true for all of the element
